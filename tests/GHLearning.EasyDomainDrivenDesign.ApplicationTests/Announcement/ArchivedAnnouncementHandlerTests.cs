...
public class ArchivedAnnouncementHandlerTests
{
	[Fact]
	public async Task Handle_ShouldArchiveAnnouncement_AndDispatchEvents()
	{
		...
		var command = new ArchivedAnnouncementCommand(announcementId);
		...
		// Act
		var sut = new ArchivedAnnouncementHandler(fakeRepository, fakeDispatcher);
